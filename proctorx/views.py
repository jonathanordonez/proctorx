...
def get_json5(request):
    return JsonResponse({'fieldX': 'field1', 'field2':'field2','field3':'field3'})


def get_json4(request):
    return JsonResponse({'field1': 'field1', 'field2':'field2'})
